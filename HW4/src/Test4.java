...
public class Test4 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (!Test4.class.desiredAssertionStatus()) {
            System.err.println(
                "You must pass the -ea option to the Java Virtual Machine."
            );
        ...
        System.out.print(
            "testing whether generateWilson() generates perfect mazes... "
        );
        ...
        assert (cnt > (1 - delta) * mu &&
            cnt < (1 + delta) * mu) : "not uniform";
        System.out.println("\t\t\t[OK]");
    }
}
